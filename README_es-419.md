# Prompts de GPT Image 2 de Inex — Anime Cinematográfico, Cultura Brasileña y Más

> 🎨 A personal collection of high-detail prompts for **GPT Image 2** — OpenAI's next-gen image model.
...
[![Español](https://img.shields.io/badge/Espa%C3%B1ol-Click_to_View-lightgrey?style=flat-square)](./README_es-ES.md)
![Español (Latinoamérica)](https://img.shields.io/badge/Espa%C3%B1ol%20%28Latinoam%C3%A9rica%29-Current-brightgreen?style=flat-square)
...
Este README todavía no está traducido. Consultá la [versión en inglés](./README.md).

This README has not been translated yet. Please view the [English version](./README.md).

---

<!--
    TRANSLATION NOTES FOR FUTURE CONTRIBUTORS:

    This is a stub file for the Español (Latinoamérica) translation of the main README.

    When translating, please:

    1. KEEP the language switcher bar above unchanged — it's auto-formatted for consistency.
    2. KEEP all prompt blocks (inside ``` fences) in ENGLISH — GPT Image 2 performs significantly
       better with English prompts, so the prompts themselves are not translated.
    3. KEEP tags (`anime`, `cinematic`, etc.) in English — they are technical keywords.
    4. KEEP names of artists, places, and cultural references (e.g. "Makoto Shinkai",
       "Mestre Vitalino", "Olinda", "São Francisco") in their original form.
    5. TRANSLATE:
        - The introductory sections ("About This Repo", "How to Use", etc.)
        - Category names and descriptions
        - The "Why it works" explanations
        - The "Variations" suggestions
        - The "Requires" notes
        - The General Prompting Tips
    6. Reference the English README at ./README.md as the source of truth.

    Once translation is complete, remove this comment block.
-->
